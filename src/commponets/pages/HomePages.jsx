...
const homepages = () => {
  return (
    <div className="pb-10 overflow-hidden homepage">
      <div className="container px-4 mx-auto">
        <div className="grid items-center grid-cols-1 pt-32 hero md:grid-cols-2">
          <div className="box">
            ...
            >
              a Full Stack developer based in Indonesia, Adi, UK. I have worked
              on a wide range of Full Stack Dev projects, from Petani Pintar
              applications to eCommerce booking platforms, with a focus on
              creating clean, well-crafted interfaces that not only look great
        ...
        <div className="pt-32 services " id="services">
          ...
          <Marquee pauseOnHover direction="right" speed={100} delay={1}>
            <div className="image_wrapper px-7">
              <img src={img} alt="Img" className=" size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img2} alt="Img2" className="size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img3} alt="Img3" className="size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img7} alt="Img7" className="size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img5} alt="Img5" className="size-32" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img6} alt="Img6" className="size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img4} alt="Img4" className="size-32" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img8} alt="Img8" className="size-24" />
            </div>
            <div className="image_wrapper px-7">
              <img src={img15} alt="Img15" className="size-20" />
            </div>
          </Marquee>
          <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700" />
          <motion.p
          ...
          <Marquee pauseOnHover direction="left" speed={100} delay={1}>
            <div className="px-12 image_wrapper">
              <img src={img9} alt="Img9" className=" size-24" />
            </div>
            <div className="px-12 image_wrapper">
              <img src={img10} alt="Img10" className="size-24" />
            </div>
            <div className="px-12 image_wrapper">
              <img src={img11} alt="Img11" className="size-24" />
            </div>
            <div className="px-12 image_wrapper">
              <img src={img12} alt="Img12" className="size-24" />
            </div>
            <div className="px-12 image_wrapper">
              <img src={img13} alt="Img13" className="size-28" />
            </div>
            <div className="px-12 image_wrapper">
              <img src={img14} alt="Img14" className="size-28" />
            </div>
          </Marquee>
        </div>
            ...
            <div class="rounded p-2  bg-white shadow group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
              ...
              <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                <h1 class="font-dmserif text-3xl font-bold text-white">
                  Application for Controlling Nutrienty
                </h1>
                <p class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  Controlling Nutrient Needs in Android-Based Hydroponic Plants
                  Smart Hidroponic
                </p>
